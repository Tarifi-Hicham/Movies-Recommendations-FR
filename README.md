...
```
Reload the changes made above and create directories for HDFS, including the Namenode, Datanode, and logs (Hicham, replace 'my user' with your username.):
```bash
source ~/.bashrc
mkdir -p /home/hicham/hdfs/namenode
mkdir -p /home/hicham/hdfs/datanode
...
<configuration>
 ...
 <value>file:///home/hicham/hdfs/namenode</value>
 <description>NameNode directory for namespace and transaction logs storage.</description>
 </property>
 <property>
 <name>dfs.datanode.data.dir</name>
 <value>file:///home/hicham/hdfs/datanode</value>
